...
/**
 * A {@link View.OnTouchListener} that makes the list items in a {@link}
...
public class SwipeableRecyclerViewTouchListener implements RecyclerView.OnItemTouchListener {
    ...
    /**
     * Constructs a new swipe touch listener for the given {@link }
     *
    ...
    public interface SwipeListener {
         ...
         *
         * @param recyclerView           The originating {@link}.
